...
$s1 = "INSERT INTO compass SET number_correct =" . intval($_POST["number_correc"]) . ", number_task= " . intval($_POST["number_task"]) . ", average_time= " . floatval($_POST["average_time"]) . ", id_student='" . $student_id . "'" . ", array_result='" . mysql_real_escape_string($_POST["array_result"]) . "'";
